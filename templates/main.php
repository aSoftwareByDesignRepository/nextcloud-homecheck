...
<div id="homecheck-app" class="hmk-app">
	<a class="hmk-skip" href="#hmk-main"><?php p($l->t('Skip to apps')); ?></a>

	<header class="hmk-header">
		<div class="hmk-header__titles">
			<h1 class="hmk-title"><?php p($l->t('HomeCheck')); ?></h1>
			<p class="hmk-subtitle" id="hmk-subtitle"><?php p($l->t('Tap a card to open an app.')); ?></p>
		</div>
		<div class="hmk-header__actions">
			<button type="button" class="button-vue hmk-btn hmk-btn--ghost" id="hmk-new-folder" hidden>
				<?php p($l->t('New folder')); ?>
			</button>
			<button type="button" class="button-vue hmk-btn hmk-btn--primary" id="hmk-edit-toggle" aria-pressed="false">
				<?php p($l->t('Edit')); ?>
			</button>
		</div>
	</header>

	<div id="hmk-edit-banner" class="hmk-edit-banner" hidden role="status" aria-live="polite">
		<span class="hmk-edit-banner__text"><?php p($l->t('Drag cards to reorder. Tap Done when finished.')); ?></span>
	</div>

	<div id="hmk-cta" class="hmk-cta" hidden role="region" aria-label="<?php p($l->t('Start page')); ?>">
		<p class="hmk-cta__text"><?php p($l->t('Make HomeCheck your start page after login?')); ?></p>
		<div class="hmk-cta__actions">
			<button type="button" class="button-vue hmk-btn hmk-btn--primary" id="hmk-cta-yes"><?php p($l->t('Use as start page')); ?></button>
			<button type="button" class="button-vue hmk-btn hmk-btn--ghost" id="hmk-cta-no"><?php p($l->t('Not now')); ?></button>
		</div>
	</div>
	...
	<dialog id="hmk-folder-dialog" class="hmk-dialog" aria-labelledby="hmk-folder-title">
		<div class="hmk-dialog__head">
			...
			<button type="button" class="button-vue hmk-btn hmk-btn--ghost" id="hmk-folder-close" aria-label="<?php p($l->t('Close')); ?>">×</button>
		</div>
	...
	<dialog id="hmk-prompt-dialog" class="hmk-dialog hmk-dialog--prompt" aria-labelledby="hmk-prompt-title">
		...
		<div class="hmk-dialog__actions">
			<button type="button" class="button-vue hmk-btn hmk-btn--ghost" id="hmk-prompt-cancel"><?php p($l->t('Cancel')); ?></button>
			<button type="button" class="button-vue hmk-btn hmk-btn--primary" id="hmk-prompt-ok"><?php p($l->t('Save')); ?></button>
		</div>
	</dialog>
	...
	<dialog id="hmk-confirm-dialog" class="hmk-dialog hmk-dialog--confirm" aria-labelledby="hmk-confirm-message">
		...
		<div class="hmk-dialog__actions">
			<button type="button" class="button-vue hmk-btn hmk-btn--ghost" id="hmk-confirm-cancel"><?php p($l->t('Cancel')); ?></button>
			<button type="button" class="button-vue hmk-btn hmk-btn--danger" id="hmk-confirm-ok"><?php p($l->t('Delete')); ?></button>
		</div>
	</dialog>
	...
	<dialog id="hmk-folder-picker" class="hmk-dialog hmk-dialog--picker" aria-labelledby="hmk-folder-picker-title">
		...
		<div class="hmk-dialog__actions">
			<button type="button" class="button-vue hmk-btn hmk-btn--ghost" id="hmk-folder-picker-cancel"><?php p($l->t('Cancel')); ?></button>
		</div>
	</dialog>
</div>
